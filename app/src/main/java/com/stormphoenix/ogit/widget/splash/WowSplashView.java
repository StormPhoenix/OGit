package com.stormphoenix.ogit.widget.splash;
...
import com.stormphoenix.ogit.widget.splash.support.SvgPathParser;
...
public class WowSplashView extends View {
    ...
    private String mTitle = "Oh Github";
    ...
    public WowSplashView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTowerPath = new SvgPathParser().parsePath(context.getResources().getString(R.string.image_logo_path));
